...
<main>
  ...
  <div class="container">
    <h1 class="text-light text-center mt-2"><strong>Actualizar producto</strong></h1>
      ...
      <form class="col-4" action="index.php?c=producto&a=actualizar" method="POST">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <input type="number" min="0" step="0.01" class="form-control" id="precio" name="precio" placeholder="Precio del producto" autocomplete="off" value="<?php echo $producto['precio']; ?>">
          </div>
          <div class="form-group">
