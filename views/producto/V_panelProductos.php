          ...
          <tr class="table-default">
            ...
            <td>
              <button type="button" class="btn btn-primary  btn-sm me-2 ">
                <a class="text-light" href="index.php?c=producto&a=editar&id=<?php echo $producto['id_producto']; ?>">
              ...
              <button type="button" class="btn btn-warning  btn-sm">
                <a class="text-light" href="index.php?c=producto&a=eliminar&id=<?php echo $producto['id_producto']; ?>">
