    ...
    <table class="table table-dark table-striped table-bordered table-hover text-center">
      <thead>
        <tr>
          ...
          <th scope="col" class="col-5">Porcentaje de Asistencia</th>
          ...
          <tr class="table-default">
            ...
            <td class="text-primary">
              ...
              <div class="progress">
                ...
                <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" style="width: 100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><span class="text-dark text-center"><strong>80%</strong></span></div>
              </div>
            </td>
            <td>
